...
public class BancoDeDados extends SQLiteOpenHelper {
    ...
    public static final String BANCO_AGENDA = "db_senha";
    ...
    public static final String TABELA_SENHA = "tab_senha";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CRIAR_TABELA = "CREATE TABLE " + TABELA_SENHA + "(" + COLUNA_CODIGO + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
    ...
    void addSenha(Psenha psenha) {
        ...
        db.insert(TABELA_SENHA, null, valor);
        db.close();
    ...
    void apagarSenha(Psenha psenha) {
        ...
        db.delete(TABELA_SENHA, COLUNA_CODIGO + " = ?", new String[]{
    ...
    Psenha selecionarSenha(int codigo) {
        ...
        Cursor cursor = db.query(TABELA_SENHA, new String[]{COLUNA_CODIGO, COLUNA_NOME, COLUNA_SENHA},
    ...
    void atualizarSenha(Psenha psenha) {
        ...
        db.update(TABELA_SENHA, valor, COLUNA_CODIGO + " = ?", new String[]{
                String.valueOf(psenha.getCodigo())});
    ...
    public List<Psenha> listaSenha() {
        ...
        List<Psenha> senhaLista = new ArrayList<Psenha>();

        String query = "SELECT * FROM " + TABELA_SENHA;
